...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "renrencoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
unsigned int pnSeed[] =
{
    0xbfc5d772,  //114.215.197.191 
	0xc1c5d772,  //114.215.197.193
	0x8816c779,  //79 c7 16 88 
	0xc1ad95d3   //d3 95 ad c1 
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. renrencoin is probably already running."), addrBind.ToString().c_str());
        else
