...
int64 nChainStartTime = 1402493986;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    // else if(pindexBest->nHeight < (2* 365 * DAILY_BLOCKCOUNT))
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x92d091f579752fb0b3d25c6048c1013de81ae0484004dc18b2ac54c6cfd38cbc"));
		//92d091f579752fb0b3d25c6048c1013de81ae0484004dc18b2ac54c6cfd38cbc
