...
const string strMessageMagic = "renrencoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in renrencoin
    bool fStrictPayToScriptHash = true; // Always active in renrencoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "renrencoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "RRC TO DA MOON.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1398106221;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 18888888;
        ...
        assert(block.hashMerkleRoot == uint256("0x1807b9f474e65965f65eb127f6abf6f5461923bf943a5dd67e13ffa5dbc5ab5e"));
